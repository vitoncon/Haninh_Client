...
export class AppMenu implements OnInit {
    ...
    private filterMenuItemsByRoles(items: any[], roles: number[]): any[] {
        const hasAllowedRole = (item: any) => {
            const allowed: number[] = Array.isArray(item?.roles) ? item.roles : [];
            if (allowed.length === 0) return true;
            return roles.some((r) => allowed.includes(r));
        };

        return (items || [])
            .filter((item) => hasAllowedRole(item))
            .map((item) => {
                if (Array.isArray(item.items)) {
                    return { ...item, items: this.filterMenuItemsByRoles(item.items, roles) };
                }
                return item;
            })
            .filter((item) => {
    ...
    ngOnInit() {
            ...
            },
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        routerLink: ['/features/courses/student'],
                        permissions: [PermissionService.PERMISSIONS.COURSES_VIEW],
                        roles: [3]
                    },
                    {
                    ...
                    },
                    {
                        ...
                        routerLink: ['/features/my-schedule'],
                        permissions: [PermissionService.PERMISSIONS.SCHEDULE_VIEW],
                        roles: [2]
                    },
                    {
                        ...
                        routerLink: ['/features/attendance'],
                        permissions: [PermissionService.PERMISSIONS.ATTENDANCE_VIEW],
                        roles: [2]
                    },
                ]
            },
            ...
            },
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        routerLink: ['/features/fees/student'],
                        permissions: [PermissionService.PERMISSIONS.FEES_VIEW],
                        roles: [3]
                    },
                ]
                ...
                items: [
                    {
                        ...
                        routerLink: ['/features/leads'],
                        permissions: [PermissionService.PERMISSIONS.LEADS_VIEW]
                    },
                    {
        ...
        // Filter menu items based on role, then permissions
        const roleFiltered = this.filterMenuItemsByRoles(allMenuItems, roles);
        this.model = this.permissionService.getFilteredMenuItems(roleFiltered);
    }
}
