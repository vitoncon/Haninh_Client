    ...
    public static readonly ROLE_PERMISSIONS: RolePermission[] = [
        {
            ...
            permissions: [
                ...
                { id: 18, name: 'Study Results View', code: PermissionService.PERMISSIONS.STUDY_RESULTS_VIEW },
                { id: 19, name: 'Study Results Create', code: PermissionService.PERMISSIONS.STUDY_RESULTS_CREATE },
                { id: 20, name: 'Study Results Edit', code: PermissionService.PERMISSIONS.STUDY_RESULTS_EDIT },
                { id: 21, name: 'Study Results Delete', code: PermissionService.PERMISSIONS.STUDY_RESULTS_DELETE },
                { id: 22, name: 'Certificates View', code: PermissionService.PERMISSIONS.CERTIFICATES_VIEW },
                { id: 23, name: 'Certificates Create', code: PermissionService.PERMISSIONS.CERTIFICATES_CREATE },
                { id: 24, name: 'Certificates Edit', code: PermissionService.PERMISSIONS.CERTIFICATES_EDIT },
                { id: 25, name: 'Certificates Delete', code: PermissionService.PERMISSIONS.CERTIFICATES_DELETE },
                { id: 26, name: 'Teacher View', code: PermissionService.PERMISSIONS.TEACHER_VIEW },
                { id: 27, name: 'Teacher Create', code: PermissionService.PERMISSIONS.TEACHER_CREATE },
                { id: 28, name: 'Teacher Edit', code: PermissionService.PERMISSIONS.TEACHER_EDIT },
                { id: 29, name: 'Teacher Delete', code: PermissionService.PERMISSIONS.TEACHER_DELETE },
                { id: 30, name: 'Teaching Assignments View', code: PermissionService.PERMISSIONS.TEACHING_ASSIGNMENTS_VIEW },
                { id: 31, name: 'Teaching Assignments Create', code: PermissionService.PERMISSIONS.TEACHING_ASSIGNMENTS_CREATE },
                { id: 32, name: 'Teaching Assignments Edit', code: PermissionService.PERMISSIONS.TEACHING_ASSIGNMENTS_EDIT },
                { id: 33, name: 'Teaching Assignments Delete', code: PermissionService.PERMISSIONS.TEACHING_ASSIGNMENTS_DELETE },
                { id: 34, name: 'Fees View', code: PermissionService.PERMISSIONS.FEES_VIEW },
                { id: 35, name: 'Fees Create', code: PermissionService.PERMISSIONS.FEES_CREATE },
                { id: 36, name: 'Fees Edit', code: PermissionService.PERMISSIONS.FEES_EDIT },
                { id: 37, name: 'Fees Delete', code: PermissionService.PERMISSIONS.FEES_DELETE },
            ]
        },
        {
